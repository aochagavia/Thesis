...
% \hline
% Function using guards in the form \haskell{cond} and \haskell{not cond} & Same function using a top-level if statement
% \end{tabular}
% \end{center}

% Let Ask-Elle reason about functions
